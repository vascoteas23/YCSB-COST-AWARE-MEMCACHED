 ...
 */
public class UniformIntGenerator extends NumberGenerator {
   ...
   */
  public UniformIntGenerator(int lb, int ub) {
    this.lb = lb;
    this.ub = ub;
  ...
  public int nextIntValue() {
    int ret = Math.abs(ThreadLocalRandom.current().nextInt()) % interval  + lb;
    setLastValue(ret);
